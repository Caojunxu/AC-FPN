    ...
    for i in sorted_inds:
        ...
        if show_class:
            ax.text(
                ...
                family='serif',
                bbox=dict(
                    facecolor='#76EE00', alpha=0.3, pad=0, edgecolor='none'),
                color='white')
...
def vis_one_image_gt(
        im, im_name, output_dir, boxes, cls, dpi=200, box_alpha=0.0, show_class=False,
        ext='pdf'):
    """Visual debugging of detections."""
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    ...
    for i in sorted_inds:
        ...
        ax.add_patch(
            plt.Rectangle((bbox[0], bbox[1]),
                          bbox[2] - bbox[0],
                          bbox[3] - bbox[1],
                          fill=False, edgecolor='#FF4500',
                          linewidth=2.8, alpha=box_alpha))
        ...
        if show_class:
            ax.text(
                ...
                family='serif',
                bbox=dict(
                    facecolor='#FF4500', alpha=0.3, pad=0, edgecolor='none'),
                color='white')
